...
txt_file_name = ""
while(txt_file_name != "sair"):
    def ssh_check(ipAdress, ssh_username, ssh_password):
    ...
    menuselector= """
        +++++++++  Backup Config - Automation Menu  +++++++++++++++
            -- Digite 1 para realizar o backup da Running-config com busca de credenciais automatica:
            -- Digite 2 para realizar o backup da Startup-config com busca de credenciais automatica:
